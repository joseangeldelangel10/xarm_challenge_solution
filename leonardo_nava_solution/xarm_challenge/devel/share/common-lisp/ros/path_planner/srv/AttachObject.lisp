...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AttachObject-request>)))
  ...
  (cl:format cl:nil "# Keep in mind that this service only acts a simulation of the grasping, you'll need to close the grip using move it !~%~%bool action # attach object to the end effector~%string frame # frame to be attached to the end effector~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AttachObject-request)))
  "Returns full string definition for message of type 'AttachObject-request"
  (cl:format cl:nil "# Keep in mind that this service only acts a simulation of the grasping, you'll need to close the grip using move it !~%~%bool action # attach object to the end effector~%string frame # frame to be attached to the end effector~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AttachObject-response>)))
  ...
  (cl:format cl:nil "bool status # bool that indicates that the object has been attached properly~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AttachObject-response)))
  "Returns full string definition for message of type 'AttachObject-response"
  (cl:format cl:nil "bool status # bool that indicates that the object has been attached properly~%~%~%~%"))
