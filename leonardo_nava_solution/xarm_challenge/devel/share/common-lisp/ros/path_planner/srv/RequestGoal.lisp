...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RequestGoal-request>)))
  ...
  (cl:format cl:nil "# you can request either a pick (target of the box to colect) or place (destination of the box)~%string action~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RequestGoal-request)))
  "Returns full string definition for message of type 'RequestGoal-request"
  (cl:format cl:nil "# you can request either a pick (target of the box to colect) or place (destination of the box)~%string action~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RequestGoal-response>)))
  ...
  (cl:format cl:nil "string goal # name of the destination frame, the activity ends with the string \"end\"~%bool status # bool to check if the current movement is possible (for example you can't ask for to place actions)~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RequestGoal-response)))
  "Returns full string definition for message of type 'RequestGoal-response"
  (cl:format cl:nil "string goal # name of the destination frame, the activity ends with the string \"end\"~%bool status # bool to check if the current movement is possible (for example you can't ask for to place actions)~%~%~%~%"))
